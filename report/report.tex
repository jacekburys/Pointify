...
(diagram of the client server communication)
\newpage
\subsection{Client}
...
\subsection{Dual Camera Sensors}
When performing the calibration we noticed that the calibration was slightly off....
\\
(image of calibration without registered and with registered)
